...
如果执行的语句是select ID from T where k between 3 and 5，这时只需要查ID的值，而ID的值已经在k索引树上了，因此可以直接提供查询结果，不需要回表。也就是说，在这个查询里面，索引k已经“覆盖了”我们的查询需求 （索引k辅助索引，他的叶子结点上已经包含了主键的值），我们称为覆盖索引。
...
![image](E:\研究生学习\Work\技术笔记\MySQL索引实践.assets\2019-03-24-122440.png)

![image](E:\研究生学习\Work\技术笔记\MySQL索引实践.assets\2019-03-24-123250.png)
...
这里我们的评估标准是，索引的复用能力。因为可以支持最左前缀，所以当已经有了(a,b)这个联合索引后，一般就不需要单独在a上建立索引了。因此，
...
![image](E:\研究生学习\Work\技术笔记\MySQL索引实践.assets\2019-03-24-123752.png)

索引下推优化流程

![image](E:\研究生学习\Work\技术笔记\MySQL索引实践.assets\2019-03-24-123807.png)
